...
("Logitech G413 -pelinäppäimistö", 79, null,"Mekaaninen, taustavalaistu G413-pelinäppäimistö tarjoaa vertaansa vailla olevaa suorituskykyä sekä edistyksellistä tekniikkaa ja ominaisuuksia.", "Ammattilaispelaajien maailmanlaajuisesti käyttämien Romer-G™-kytkinten ansiosta G413 on lyömätön nopeudeltaan, herkkyydeltään ja kestävyydeltään. Kauniiden yksityiskohtien ansiosta G413 on näyttävä näppäimistö. Kevytrakenteinen ja erittäin kestävä 5052-alumiiniseoskotelo lisää jämäkkyyttä ja tarjoaa huippuluokan ulkoasun sekä ohuen ja terävän profiilin. Tasapainoisessa G413:ssa on juuri oikeat ominaisuudet: tarkat, taustavalaistut näppäimet, USB läpivienti ja integroidut medianäppäimet.", "http://localhost/verkkokauppa/img/19.jpeg"),
("HyperX Cloud II Wireless Headset", 169, null,"Legendaarinen mukavuustaso, nyt langattomasti", "HyperX Cloud II on valmistettu erittäin mukavaksi pelaajien kuulokemikrofoniksi, joka tuottaa upean äänen. Suunnittelemme huolellisesti tunnusomaiseen HyperX-vaahtomuoviimme, ensiluokkaiseen keinonahkaan, puristusvoimaan ja painon jakautumiseen liittyvät yksityiskohdat. Ei ihme, että tästä mallista on tullut miljoonien pelaajien mieluisin kuulokemikrofoni. Olemme ylpeitä saadessamme esitellä langattomat HyperX Cloud II -kuulokkeet. Kun käytettävissä ovat 2,4 GHz:n langaton yhteys, jopa 30 tuntia kestävä akku ja langaton 20 metrin kantama, tiedossa on kokonainen päivä mukavuutta ja langatonta vapautta.", "http://localhost/verkkokauppa/img/20.jpg"),
("Logitech G PRO X -pelikuulokkeet", 119, null,"Logitech G Pro X -kuulokkeiden äänenlaatu on ammattilaistasoa niin puhuessa kuin kuunnellessakin.", "Blue VO!CE -mikrofonitekniikalla viestit selkeämmin ja itsevarmemmin. Irroitettavat, ammattilaistason mikrofonisuodattimet säätävät äänestäsi reaaliajassa sävykkäämmän, puhtaamman ja selkeän. Edistykselliset kaiutinelementit on valmistettu erityisestä verkkokankaasta. Ne tarjoavat selkeän ja tarkan äänen sijoittelun ja parannellun basson. Askeleet ja ympäristön äänet kuuluvat selkeästi, mikä on eduksi pelissä. Uuden sukupolven 7.1-tilaäänellä voit hahmottaa sijainnin ja etäisyyden tarkemmin: tiedät siis tarkalleen vastustajien sijainnin ennen kuin he löytävät sinut, ja peli tempaa paremmin mukaansa.", "http://localhost/verkkokauppa/img/21.jpeg");
...
(19, "Näppäimistöt", "oheislaitteet"),
(20, "Kuulokkeet", "oheislaitteet"),
(21, "Kuulokkeet", "oheislaitteet");
