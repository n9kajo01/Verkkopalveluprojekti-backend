...
("Logitech G502 HERO -pelihiiri", 79.90,null ,"Tehokkaassa suosikkipelihiiressäsi on nyt entistä tarkemmat toiminnot.", "Mukauta RGB-valaistus tyyliisi ja ympäristöösi sopivaksi tai synkronoi se muiden Logitech G -tuotteiden kanssa. Suorituskykyisessä G502 HERO -pelihiiressä on seuraavan sukupolven optinen HERO 16K -tunnistin, jolla saat suurimman mahdollisen seurantatarkkuuden. Olipa pelityylisi mikä tahansa, G502 HERO on helppo säätää vaatimustesi mukaiseksi: määritä mukautettuja profiileja pelejäsi varten, säädä herkkyyttä tai asettele viisi 3,6 gramman painoa juuri sopivan tasapainon ja tuntuman saavuttamiseksi.", "http://localhost/verkkokauppa/img/18.jpg");
