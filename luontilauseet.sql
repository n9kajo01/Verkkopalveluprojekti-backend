...
("PowerColor Radeon RX 6700 XT Red Devil", 900, "AMD Radeon RX 6700 XT näytönohjain, jota vauhdittaa AMD RDNA 2 arkkitehtuuri, 40 tehokasta laskentayksikköä.", "AMD Radeon RX 6700 XT näytönohjain, jota vauhdittaa AMD RDNA 2 arkkitehtuuri, 40 tehokasta laskentayksikköä, 96 Mt AMD Infinity Cache ja 12 Gt GDDR6 -muistia. AMD Radeon RX 6700 XT -sarja tuo pelikoneeseesi kaiken mitä tarvitset uuden sukupolven huippupelien pelaamiseen tarjoamalla runsaasti suorituskykyä, uskomattomat tehosteet ja pelifysiikan, sekä uusimmat ominaisuudet.", "http://localhost/verkkokauppa/img/12.png");
